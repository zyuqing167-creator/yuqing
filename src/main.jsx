...
function App() {
  ...
  const projectIcons = ['/portfolio-assets/icons/03-project-02.png', '/portfolio-assets/icons/03-project-03.png']
  const projectData = [
    ...
    <>
      <header className={`site-header${isNavScrolled ? ' is-scrolled' : ''}`}>
        <nav className="navbar" aria-label="主导航">
          <a className="identity" href="#home" aria-label="返回首页">
            <img className="logo-mark" src="/portfolio-assets/icons/01-navbar-bg-logo.png" alt="" />
      ...
      <main className="portfolio">
        <section className="hero" id="home" aria-label="首页">
          <video className="hero-video" autoPlay muted loop playsInline poster="/portfolio-assets/hero/静态默认hero-02.png">
            <source src="/portfolio-assets/hero/动态默认hero-03.mp4" type="video/mp4" />
          </video>
        ...
        <div className="hero-content">
          ...
          <a className="explore" href="#project"><img src="/portfolio-assets/icons/02-hero.png" alt="Explore Projects" /></a>
        </div>
      </section>
      ...
      <section className="about section-shell" id="about">
        ...
        <div className="about-main">
          <div className="portrait-frame">
            <img className="portrait" src="/portfolio-assets/avatar/头像.png" alt="张家祥头像" />
          </div>
